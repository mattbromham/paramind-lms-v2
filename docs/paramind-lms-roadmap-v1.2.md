...
*AI-first workflow: Cursor agent writes code → ChatGPT plans & reviews*
...
| 0-2 | **Project Board** | Create GitHub Projects columns *Backlog → In Progress → Review → Done*. | All tickets below created & ordered. | 30 m |
